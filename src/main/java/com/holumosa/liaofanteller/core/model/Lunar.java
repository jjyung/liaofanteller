...
public class Lunar implements Serializable {
  ...
  @Serial private static final long serialVersionUID = 4986391064617411454L;
  ...
  public String toString() {
    return getYear()
        + "("
        + LunarUtil.cyclical(getYear())
        + ")年"
        + (isLeap() ? "閏" : "")
        + LunarUtil.getChnMonth(getMonth())
        + "月"
   ...
   * To string.
   *
   * @param outputYear the output year
   * @param outputMonth the output month
   * @param outputDay the output day
   * @return the string
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (leap != other.leap) return false;
