...
public final class Cell implements Serializable {
  ...
  /** The borrow cells. */
  @JsonIgnore private List<BorrowCell> borrowCells = new ArrayList<BorrowCell>();
  ...
  /** The prev cell. */
  @JsonIgnore private transient Cell prevCell = null;

  /** The next cell. */
  @JsonIgnore private transient Cell nextCell = null;
   ...
   *
   * @param preGeneralStar the new pre general star
   */
   ...
   *
   * @param preAgeStar the new pre age star
   */
   ...
   *
   * @param preDoctorStar the new pre doctor star
   */
   ...
   *
   * @param borrowCells the new borrow cells
   */
   ...
   * Sets the age start.
   *
   * @param ageStart the new age start
   */
   ...
   * Sets the persist12.
   *
   * @param periodLevel the new persist12
   */
   ...
   * Sets the prev cell.
   *
   * @param prevCell the new prev cell
   */
