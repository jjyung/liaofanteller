...
import com.holumosa.liaofanteller.util.CommonUtils.MapWrapper;
import java.util.*;
...
public final class Data {
  ...
  public static final MinorStar[] BAD_STARS =
      new MinorStar[] {
        MinorStar.MINOR_STAR_EMPTY_GROUND,
        MinorStar.MINOR_STAR_GROUND_DISASTER,
        MinorStar.MINOR_STAR_FIRE_BURN,
        MinorStar.MINOR_STAR_INVISIBLE_PROBLEM,
        MinorStar.MINOR_STAR_FAILURE,
        MinorStar.MINOR_STAR_HINDER
      };

  /** The Constant BAD_STARS_AND_REACTION_PROBLEM. */
  public static final StarElement[] BAD_STARS_AND_REACTION_PROBLEM =
      new StarElement[] {
        MinorStar.MINOR_STAR_EMPTY_GROUND, MinorStar.MINOR_STAR_GROUND_DISASTER,
            MinorStar.MINOR_STAR_FIRE_BURN,
        MinorStar.MINOR_STAR_INVISIBLE_PROBLEM, MinorStar.MINOR_STAR_FAILURE,
            MinorStar.MINOR_STAR_HINDER,
        StarReaction.STAR_TO_PROBLEM
      };

  /** The Constant FOUR_BAD_STARS. */
  public static final MinorStar[] FOUR_BAD_STARS =
      new MinorStar[] {
        MinorStar.MINOR_STAR_FIRE_BURN,
        MinorStar.MINOR_STAR_INVISIBLE_PROBLEM,
        MinorStar.MINOR_STAR_FAILURE,
  ...
  public static final StarElement[] FOUR_BAD_STARS_AND_REACTION_PROBLEM =
      new StarElement[] {
        MinorStar.MINOR_STAR_FIRE_BURN,
        MinorStar.MINOR_STAR_INVISIBLE_PROBLEM,
        MinorStar.MINOR_STAR_FAILURE,
  ...
  public static final Star[] EMPTY_STARS =
      new Star[] {
        MinorStar.MINOR_STAR_EMPTY_GROUND,
        MiniStar.MINI_STAR_EMPTY_SKY,
        MiniStar.MINI_STAR_LAZY_SKY,
        MiniStar.MINI_STAR_LAZY_SKY2,
        MiniStar.MINI_STAR_INTERRUPT_SKY,
        MiniStar.MINI_STAR_INTERRUPT_SKY2
      };

  /** The Constant GOOD_STARS. */
  public static final MinorStar[] GOOD_STARS =
      new MinorStar[] {
        MinorStar.MINOR_STAR_CLOTH,
        MinorStar.MINOR_STAR_CLEVER,
        MinorStar.MINOR_STAR_SKILL,
        MinorStar.MINOR_STAR_HONOR,
        MinorStar.MINOR_STAR_HONOR2,
        MinorStar.MINOR_STAR_LEFT_SUPPORT,
        MinorStar.MINOR_STAR_RIGHT_SUPPORT
      };

  /** The Constant GOOD_STARS_AND_REACTION_TREASURE. */
  public static final StarElement[] GOOD_STARS_AND_REACTION_TREASURE =
      new StarElement[] {
        MinorStar.MINOR_STAR_CLOTH,
        MinorStar.MINOR_STAR_CLEVER,
        MinorStar.MINOR_STAR_SKILL,
  ...
  /** The Constant GOOD_STARS. */
  public static final Star[] ROMANCE_STARS =
      new Star[] {
        MinorStar.MINOR_STAR_SKILL,
        MiniStar.MINI_STAR_SKY_ROMANTIC,
        MiniStar.MINI_STAR_BAD_ROMANCE,
        MiniStar.MINI_STAR_BAD_ROMANCE2,
        MiniStar.MINI_STAR_RED_MARRIAGE
      };

  /** The Constant RUNTIME_MINOR_STARS. */
  public static final MinorStar[] RUNTIME_MINOR_STARS =
      new MinorStar[] {
        MinorStar.MINOR_STAR_CLEVER,
        MinorStar.MINOR_STAR_CLOTH,
        MinorStar.MINOR_STAR_EMPTY_GROUND,
        ...
        MinorStar.MINOR_STAR_HONOR,
        MinorStar.MINOR_STAR_HONOR2,
        MinorStar.MINOR_STAR_HORSE_CHANGE,
        MinorStar.MINOR_STAR_INVISIBLE_PROBLEM,
        MinorStar.MINOR_STAR_LEFT_SUPPORT,
        MinorStar.MINOR_STAR_RIGHT_SUPPORT,
        MinorStar.MINOR_STAR_SKILL
  ...
  public static final FiveElement[][] fiveElementMap =
      new FiveElement[][] {
        new FiveElement[] {
          FiveElement.GOLD,
          FiveElement.WATER,
  ...
  public static enum GroundTime {
     ...
     */
    private GroundTime(
        String displayName, int index, String timePeriod, int startHour, int endHour) {
    ...
    public static GroundTime getByIndex(int index) {
      return GroundTime.values()[CommonUtils.mod(index, GroundTime.values().length)];
    }

    public static GroundTime getByHour(int hour) {
      GroundTime[] values = GroundTime.values();
      for (GroundTime value : values) {
        if (hour >= value.getStartHour() && hour < value.getEndHour()) return value;
      }
      throw new RuntimeException(String.format("invalid hour: %d", hour));
    }
  ...
  public static class DoubleMonth {
    ...
    private static Map<Integer, Integer> getyearDoubleMonthMapping() {
      MapWrapper<Integer, Integer> mapWrapper =
          new MapWrapper<Integer, Integer>(new HashMap<Integer, Integer>());
      ...
      yearDoubleMonthMatrix.add(
          new int[] {1860, 1879, 1898, 1936, 1955, 1966, 1993, 2031, 2050}); // 3
      yearDoubleMonthMatrix.add(
          new int[] {1849, 1868, 1887, 1906, 1925, 1944, 1963, 1974, 1982, 2001, 2012, 2020}); // 4
      yearDoubleMonthMatrix.add(
          new int[] {
            1857, 1865, 1876, 1884, 1895, 1903, 1914, 1922, 1933, 1952, 1971, 1990, 1998, 2009,
            2028, 2039, 2047
          }); // 5
      yearDoubleMonthMatrix.add(
          new int[] {1873, 1892, 1911, 1930, 1941, 1960, 1979, 1987, 2017, 2025, 2036}); // 6
    ...
    public static boolean checkDoubleMonthValid(int year, int month) {
      return getYearDoubleMonth(year)
          .map(
              doubleMonth -> {
